		...
		<view class="content">
			...
			<view class="member-card">
				<view class="info">
					...
					<image @tap="info" src="/static/images/my/avatar.png" class="avatar"></image>
					<view class="badage">
						Lv2
					</view>
				</view>
				<view class="row">
					...
					<navigator class="grid" open-type="navigate" url="/pages/my/wallet">
						...
						<view class="value">{{ wallet || '0.00' }}</view>
	...
	export default {
		...
		async onLoad() {
			...
			if (this.isLogin) {
				...
				this.points = userStats.points
				this.coupons = userStats.coupons
				this.wallet = userStats.wallet
				this.giftCards = userStats.giftCards
			}
		},
		methods: {
			openLoginPopup() {
